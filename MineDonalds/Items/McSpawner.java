...
import MineDonalds.Other.McEntityList;
...
public class McSpawner extends Item
{
    @SideOnly(Side.CLIENT)
    private Icon theIcon;

    public McSpawner(int par1)
    {
        super(par1);
    ...
    public String getItemDisplayName(ItemStack par1ItemStack)
    {
        ...
        String s1 = McEntityList.getStringFromID(par1ItemStack.getItemDamage());
    ...
    {
        EntityEggInfo entityegginfo = (EntityEggInfo)McEntityList.entityEggs.get(Integer.valueOf(par1ItemStack.getItemDamage()));
    ...
    {
        if (!McEntityList.entityEggs.containsKey(Integer.valueOf(par1)))
        {
            return null;
        }
        else
        {
            ...
            for (int j = 0; j < 1; ++j)
            {
                entity = McEntityList.createEntityByID(par1, par0World);
    ...
    {
        Iterator iterator = McEntityList.entityEggs.values().iterator();
