...
public class McWorldProvider2 extends WorldProvider
{
public void registerWorldChunkManager()
{
/** tells Minecraft to use our new WorldChunkManager **/
this.worldChunkMgr = new McChunkManger2(worldObj.getSeed(), terrainType);
this.hasNoSky = false;
}
...
{
return DimensionManager.createProviderFor(Main.DimID);
}
...
{
return new McChunkProvider2(worldObj, worldObj.getSeed(), true);
}
...
{
return "Building MineDonalds Dimension...";
}
