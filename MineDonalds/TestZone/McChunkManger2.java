...
public class McChunkManger2 extends WorldChunkManager
{
...
protected McChunkManger2()
{
this.myBiomeCache = new BiomeCache(this);
this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
this.myBiomesToSpawnIn.add(Main.McBiome);
this.myBiomesToSpawnIn.add(BiomeGenBase.extremeHills);
this.myBiomesToSpawnIn.add(BiomeGenBase.forestHills);
this.myBiomesToSpawnIn.add(BiomeGenBase.desertHills);
}

public McChunkManger2(long seed, WorldType worldtype)
{
this();
// i changed this to my GenLayerTutorial
GenLayer[] agenlayer = McGenLayer2.makeTheWorld(seed);
this.myGenBiomes = agenlayer[0];
this.myBiomeIndexLayer = agenlayer[1];
}

public McChunkManger2(World world)
{
...
par1ArrayOfBiomeGenBase[i] = Main.McBiome;
}
}
