...
public class BlockMcGrass extends Block
{
...
{
par1World.setBlock(par2, par3, par4, Main.McDirt.blockID);
}
...
if (par1World.getBlockId(i1, j1, k1) == Main.McDirt.blockID && par1World.getBlockLightValue(i1, j1 + 1, k1) >= 4 && par1World.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
{
par1World.setBlock(i1, j1, k1, Main.McGrass.blockID);
}
}
}
}
...
{
return Main.McDirt.idDropped(0, par2Random, par3);
}
