package MineRonalds.Dimension;

import java.util.List;
import java.util.Random;

import MineRonalds.Main;
import MineRonalds.Dimension.Trees.WorldGenMcForestTree;
import MineRonalds.Dimension.Trees.WorldGenMcHugeTree;
import MineRonalds.Dimension.Trees.WorldGenMcTree;
...
public class McChunkProvider implements IChunkProvider
{
	...
	private MapGenBase caveGenerator = new MapGenMcCaves();
	...
	public McChunkProvider(World par1World, long par2, boolean par4) {
						...
						for (int i2 = 0; i2 < 4; ++i2)
						{
							...
							for (int k2 = 0; k2 < 4; ++k2)
							{
								if ((d16 += d15) > 0.0D)
								{
									...
									par3ArrayOfByte[j2 += short1] = (byte)Main.McStone.blockID;//
								}
								else if (k1 * 8 + l1 < b2)
								{
									par3ArrayOfByte[j2 += short1] = (byte)Main.McStone.blockID;
			...
			for (int var9 = 0; var9 < 16; var9++)
			{
				...
				for (int var16 = 127; var16 >= 0; var16--)
				{
					...
					else
					{
						...
						/** Main filler block fill's all the underground, replaces block stone **/
						else if (var18 != Main.McStone.blockID)
						{
							if (var13 == -1)
							{
								if (var12 == 0)
								{
									...
									var15 = (byte)Main.McDirt.blockID;//
								}
								...
								if ((var16 < var5) && (var14 == 0))
								{
									if (var11 < 0.15F)
									{
										var14 = (byte)Main.McStone.blockID;
									}
									else
									{
										var14 = (byte)Main.McStone.blockID;
							...
							else if (var13 > 0)
							{
								var13--;
								par3ArrayOfByte[var17] = var15;
								if ((var13 == 0) && (var15 == Main.McStone.blockID))
								{
									var13 = this.rand.nextInt(4);
									var15 = (byte)Main.McStone.blockID;
								}
							}
						}
					}
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.McGrass.blockID))
                {
                        new WorldGenMcTree(true, 6 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.McGrass.blockID))
                {
                        new WorldGenMcTree(true, 4 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.McGrass.blockID))
                {
                        new WorldGenMcTree(true, 8 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.McGrass.blockID))
                {
                        new WorldGenMcTree(true, 10 + rand.nextInt(8), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.McGrass.blockID))
                {
                        new WorldGenMcTree(true, 15 + rand.nextInt(4), 0, 0, false).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 60; c > 0; c--)
        {
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.McGrass.blockID))
                {
                        new WorldGenMcForestTree(true).generate(worldObj, rand, j2, l3, j5);
                }
        }
        ...
        for (int c = 60; c > 0; c--)
        {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == Main.McGrass.blockID))
                {
                        new WorldGenMcHugeTree(true, 15 + rand.nextInt(8), 0, 0).generate(worldObj, rand, j2, l3, j5);
                }
        }
