...
public class McWorldProvider extends WorldProvider
{
	private float[] colorsSunriseSunset = new float[4];
	public void registerWorldChunkManager()
	{
		this.worldChunkMgr = new WorldChunkManagerHell(Main.McBiome, this.dimensionId, this.dimensionId);
		this.dimensionId = Main.DimID;
		this.hasNoSky = false;
	}
	public IChunkProvider createChunkGenerator()
	{
		return new McChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
	}
